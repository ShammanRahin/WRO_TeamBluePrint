...
| Drive Powertrain | Print (PLA/PETG) | 5:1 spur gear enclosure + Motor Mounts included |
| Rear Axle Bearing Brackets | Print (PETG/PLA+) | Left, Center, Right BR & Bearing Mount STLs included |
| Front & Rear Wheels | Print (PLA/PETG) | Left/Right Front and Rear Wheel STLs included |

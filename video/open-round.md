...
plus the front wall, turns a gyro-terminated 90 degrees, re-centres in the lane, and stops in the
start section after three laps.

Firmware: [`../src/open_round/OpenRound.cpp`](../src/open_round/OpenRound.cpp)
